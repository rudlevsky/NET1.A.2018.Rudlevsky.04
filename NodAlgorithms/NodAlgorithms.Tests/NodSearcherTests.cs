...
namespace NodAlgorithms.Tests
{
    ...
    public class NodSearcherTests
    {
        ...
        public int MethodGetNodE_ArrayOfNumbers_ReturnCorrectNod(int num1, int num2, int num3) =>
            NodSearcher.GetNodE(num1, num2, num3);
